...
| 组员 | 分工内容 |
|------|---------|
| 蔡俊煜（PB23050866） | 论文研读与理论分析、Pointer-Generator 完整代码复现（PyTorch LSTM 编码器 + 注意力 + 指针 + 覆盖）、BART 微调改进实验设计与实现、GPU 训练与结果对比分析、定量（ROUGE）与定性（摘要示例）结果分析、报告核心章节撰写、GitHub 仓库搭建与维护 |
| 吴润宇（PB23061203） | 课程备选论文调研与选题评估、论文背景资料收集、Pointer-Generator 与 BART 模型架构对比分析、"从零训练 vs 预训练"改进分析撰写、代码测试与验证、报告格式整理与校对 |
